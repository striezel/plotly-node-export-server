...
* __[maintenance]__
Update dependency `@csstools/css-color-parser` to 4.2.1.

* __[maintenance]__
Update dependency `@csstools/css-syntax-patches-for-csstree` to 1.1.12.
...
* __[maintenance]__
Update dependency `@asamuzakjp/dom-selector` to 6.8.1.
